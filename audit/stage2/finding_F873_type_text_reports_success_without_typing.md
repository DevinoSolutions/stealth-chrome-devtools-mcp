...
* Unit lane at the fix: **2496 passed, 1 skipped** (2484 before this work + the 12 new hermetic pins). FULL integration lane (`-m integration`, real Chrome, 189 nodes): **185 passed, 1 skipped, 2 xfailed** after the five flips in §5a — the one failure that lane surfaced was the fifth flip (`test_the_real_input_tools_emit_no_composition_at_all`, which the fix was expected to move and which is green at the flip).
