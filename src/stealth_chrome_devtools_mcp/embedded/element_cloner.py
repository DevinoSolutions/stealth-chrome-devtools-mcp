        ...
        try:
            ...
            if isinstance(asset_data, dict):
                ...
                debug_logger.log_warning(
                    "element_cloner",
                    "extract_assets",
                    f"Got unexpected type: {type(asset_data)}",
                )
                return {
                ...
                tasks.append(
                    (
                        ...
                        self.extract_element_styles(
                            tab, element, **default_options["styles"]
                        ),
                    )
                )
                ...
                tasks.append(
                    (
                        ...
                        self.extract_element_events(
                            tab, element, **default_options["events"]
                        ),
                    )
                )
                ...
                tasks.append(
                    (
                        ...
                        self.extract_element_assets(
                            tab, element, **default_options["assets"]
                        ),
                    )
                )
        ...
        try:
            ...
            if include_computed:
                debug_logger.log_info(
                    "element_cloner",
                    "extract_styles_cdp",
                    "Getting computed styles via CDP",
                )
            ...
            if include_css_rules:
                debug_logger.log_info(
                    "element_cloner",
                    "extract_styles_cdp",
                    "Getting matched styles via CDP",
                )
