...
class CDPFunctionExecutor:
    ...
    async def discover_global_functions(
        ...
        try:
            ...
            debug_logger.log_error(
                "cdp_function_executor", "discover_global_functions", e
            )
            return []
    ...
    async def discover_object_methods(
        ...
        try:
            ...
            if (
                not object_result
                or not object_result[0]
                or not object_result[0].object_id
            ):
                    ...
                    if prop.value and prop.value.type_ == "function":
                        methods.append(
                            FunctionInfo(
                                ...
                                signature=prop.value.description
                                or f"function {prop.name}()",
            ...
            debug_logger.log_error(
                "cdp_function_executor", "discover_object_methods", e
            )
            return []
    ...
    async def call_discovered_function(
        ...
        try:
            ...
            debug_logger.log_error(
                "cdp_function_executor", "call_discovered_function", e
            )
            return {
                "success": False,
                "error": str(e),
    ...
    async def inspect_function_signature(
        ...
        try:
            ...
            debug_logger.log_error(
                "cdp_function_executor", "inspect_function_signature", e
            )
    ...
    async def inject_and_execute_script(
        ...
        try:
            ...
            debug_logger.log_error(
                "cdp_function_executor", "inject_and_execute_script", e
            )
            return {"success": False, "error": str(e)}
    ...
    async def create_persistent_function(
        ...
        try:
            ...
            debug_logger.log_error(
                "cdp_function_executor", "create_persistent_function", e
            )
            return {"success": False, "error": str(e)}
    ...
    async def execute_function_sequence(
        ...
        for i, func_call in enumerate(function_calls):
            try:
                ...
                debug_logger.log_error(
                    "cdp_function_executor", "execute_function_sequence", e
                )
                results.append(
                    {
                        "sequence_index": i,
    ...
    async def execute_python_in_browser(
        ...
        try:
            ...
            debug_logger.log_error(
                "cdp_function_executor", "execute_python_in_browser", e
            )
            return {"success": False, "error": str(e)}
